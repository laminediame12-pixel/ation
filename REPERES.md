...
| Match FIFA (19/07/26) M1=Laetitia/M7=Tristitia | laetitia/laetitia/carcer/conjunctio | 10-2, **M7** | — | **MISS NET — 1er vrai match hors archive pour "Confirmation résultante+binôme"** (intégrée le 18/07/26, 21/25 sur l'archive, 9/10 isolé). `verdictFinal` avait tranché **Équipe 1** ("Laetitia confirmé par son résultante et son binôme en harmonie, M7 non"), réel **Équipe 2 gagne 10-2** — inversé, et avec un écart énorme (prédit 5-4, réel 2-10, vainqueur ET ampleur totalement faux). `BTTS` prédit Oui et confirmé (2-10, les deux marquent). Le mécanisme reste largement positif sur l'archive (21/25) mais ce premier test réel en conditions live est un échec net — track record réel désormais 0/1 pour ce palier spécifique (distinct du track record archive 9/10), à surveiller de près sur les prochains matchs avant de lui faire confiance aveuglément en usage réel |
