...
| Match FIFA (19/07/26) M1=Conjunctio/M7=Puella | conjunctio/laetitia/via/cauda_draconis | 6-5, **M1** | — | **HIT (Équipe 1) via Max des 4 forces** (M1=1060, M7=790, R1=**1080** max absolu, R7=1060), fixe et rotation d'accord. Réel **6-5 M1** — score estimé 3-1 : vainqueur correct mais **magnitude très sous-estimée dans les deux sens** (4 buts totaux prédits contre 11 réels, ET l'écart net réel +1 est même plus SERRÉ que l'écart prédit +2 — le score explose alors que la doctrine prévoyait un match fermé). `matchFermeOuvert` avait pourtant signalé **FERMÉ** (7/16 maisons fermées, "risque qu'un camp reste à 0") — **MISS net et à l'opposé** : les deux camps ont au contraire énormément marqué (track record réel désormais **6/11**, après 6/10 sur Vitesse-AEK). **8e vrai match hors archive pour le palier Max des 4 forces : 7/8** (vainqueur seul). **Test en temps réel du signal Air (voir §6, "sens pratique pour le verdict")** : M1=Conjunctio est une figure Air, précisément la catégorie identifiée comme fragile (7/8 en défaite sur l'archive) — ici **le camp Air GAGNE**, un 2e démenti réel après West Ham-Liverpool (M7=Caput Draconis, gagnant lui aussi) — le signal Air reste isolé et non intégrable, ce nouveau cas renforce la prudence déjà actée plutôt que de la contredire |
| Match FIFA (19/07/26) M1=Tristitia/M7=Populus | tristitia/carcer/populus/rubeus | 6-3, **M1** | — | **MISS NET (vainqueur) — `verdictFinal` prédit Équipe 2 (M7) via Max des 4 forces** (R7=**1015** max absolu, contre M1=575, M7=500, R1=865), score estimé 2-4 Équipe 2 — réel **6-3 Équipe 1**, vainqueur ET sens du score totalement inversés. **9e vrai match hors archive pour le palier Max des 4 forces : 7/9** (2 MISS sur les 3 derniers cas, après le très bon 6/6 initial — à surveiller de près). Pénalité prédite CONTRE Équipe 2 (Fortuna Minor en M12 mal protégée, bin:Conjunctio 27 sous seuil 40, encaisseur=M7) — direction cohérente avec la déroute réelle de M7 malgré l'erreur sur le vainqueur global. `matchFermeOuvert` avait encore signalé **FERMÉ** (9/16 maisons fermées, le taux le plus élevé de toute la session) — **2e MISS D'AFFILÉE** (après Conjunctio/Laetitia, le match précédent) : le score a explosé (9 buts au total) — **track record réel désormais 6/12**, 2 échecs consécutifs nets sur les 2 derniers vrais matchs testés, le signal FERMÉ commence à sembler moins fiable en usage réel que son 6/10 initial ne le suggérait. Ni M1 (Tristitia) ni M7 (Populus) n'est une figure Air — signal Air non applicable ici |
