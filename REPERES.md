...
| **Confirmation résultante+binôme (M1/M7)** | Le résultante d'une maison "confirme" sa figure de base si : même polarité (favorable/défavorable), binôme de la figure de base présent dans le thème, résultante en harmonie élémentaire avec la maison, et binôme lui-même en harmonie avec une de ses maisons — demande explicite utilisateur, 18/07/26. Ne tranche que si exactement un des deux camps confirme. | **PRIORITAIRE depuis le 18/07/26** (juste après la trahison directe depuis le 19/07/26) — 9/10 (90%) isolé sur l'archive, `verdictFinal` complet passe de 18/25 à **21/25 (84%)**. **1er vrai match hors archive testé (19/07/26, Laetitia/Tristitia) : MISS net** (prédit Équipe 1 5-4, réel Équipe 2 10-2), **corrigé depuis par la trahison directe** placée juste avant elle dans la cascade. **2e vrai match hors archive (19/07/26, Acquisitio/Acquisitio miroir M1=M7) : HIT** (prédit Équipe 1 3-2, réel Équipe 1 4-3 — vainqueur ET écart net corrects). **3e cas découvert le 19/07/26 (St. Louis City SC vs Sporting Kansas City, en revérifiant contre la cascade actuelle) : MISS** — confirme M7 alors que rotation ET mode fixe favorisent tous deux M1, le vainqueur réel (3-2). **4e cas (19/07/26, Laetitia/Albus) : MISS** — prédit Équipe 1 5-2, réel Équipe 2 7-3, vainqueur et score inversés — track record isolé du palier confirmation désormais **1/4 en réel**, nettement moins bon que son 9/10 sur l'archive, à surveiller de près. **Inversion de priorité testée (19/07/26, "teste" si ancrage avant confirmation ferait mieux)** : REJETÉ nettement — 17/25 contre 22/25 baseline, casse 5 matchs archive corrects (Argentine-Egypte, Fenerbahçe-Galatasaray, Chelsea-Napoli, Man City-Dortmund, Ferencvárosi-Qarabag) pour n'en réparer aucun. L'ordre actuel reste le meilleur mesuré malgré le raté sur St. Louis. **CORRIGÉ le 19/07/26 (demande utilisateur "rotation et fixe le même mode d'analyse... celui qui capte plus du vrai resultats")** : ce palier ne vérifiait la confirmation qu'en positions FIXES (M1/M7), jamais en rotation (R1/R7) — corrigé pour exiger l'accord des deux. Testé avant intégration : répare St. Louis en réel (2/4→3/4), coûte 18/27 sur l'archive (contre 22/27), meilleur compromis que la rotation seule (17/27, casse 5 matchs archive) ou l'exigence OU (22/27 mais ne répare rien en réel). Laetitia/Albus reste un MISS (même la rotation ne confirme rien sur ce cas). Voir §6 pour le détail complet des 4 variantes testées. |
...
| 2e | **Confirmation résultante+binôme (M1/M7)** | `confirmationResultanteBinome(pos, theme)` — le résultante de M1 (ou M7) "confirme" la figure de base si : polarité base=résultante (`FIGURE_MEANINGS_PERSO`) ET binôme présent dans le thème ET résultante en harmonie élémentaire avec la maison (`forceMaisonV7≥60`) ET binôme lui-même en harmonie avec une de ses maisons. Ne tranche que si EXACTEMENT un des deux camps confirme | **9/10 (90%) isolé sur l'archive** (10/27 matchs concernés) ; **21/25 (84%) pour `verdictFinal` complet avec ce palier en priorité**, contre 18/25 (72%) sans lui — +3 net (répare Argentine-Egypte, Chelsea-Napoli, Man City-Dortmund, Ferencvárosi-Qarabag ; casse Côte d'Ivoire-Norvège). **1er vrai match hors archive (19/07/26, Laetitia/Tristitia) : MISS** (prédit Équipe 1 5-4, réel Équipe 2 10-2) — **corrigé depuis par la trahison directe (2d) placée juste avant**. **3e cas réel (St. Louis vs Sporting) découvert MISS le 19/07/26 en revérifiant contre la cascade actuelle** — **4e cas (Laetitia/Albus) : MISS** (prédit Équipe 1 5-2, réel Équipe 2 7-3) — track record réel isolé désormais **1/4** — voir §3. **POINT COMMUN DES 3 MISS RECHERCHÉ (19/07/26, demande utilisateur "regarde le point commun sur les 3 miss")** : les 3 cas ne partagent PAS la même figure confirmée (Laetitia/Laetitia/Cauda Draconis), mais **2 des 3 partagent M1=Laetitia** (Laetitia/Tristitia et Laetitia/Albus) — et sur ces 2 cas, TOUS les mécanismes indépendants de la cascade s'accordaient déjà à tort sur M1 (confirmation ET "max des 4 forces" recalculé, M1=1190/1330 nettement devant M7=795/1235) : ce n'est donc pas une faiblesse propre à la confirmation résultante+binôme mais un **problème plus large, spécifique à Laetitia en M1**, qui semble surestimée par plusieurs calculs de force indépendants à la fois. **Vérifié sur l'archive** : Laetitia en base M1 apparaît sur seulement 2 matchs, et y gagne les DEUX fois (Liverpool-Lombardia 7-3, Real Madrid-Atlético 5-2) — **total Laetitia-en-M1 : 2/2 sur l'archive, 0/2 en réel, un renversement complet sur seulement n=4**. Le 3e MISS (St. Louis, confirmedFig=Cauda Draconis) est un cas DIFFÉRENT : là, "max des 4 forces" recalculé aurait au contraire donné le bon vainqueur (R1=1315 max, M1 réel) — la confirmation résultante+binôme a activement écrasé un signal correct, pas un simple accord collectif erroné comme sur Laetitia. **Conclusion : pas un point commun unique, mais deux points faibles distincts** — (1) Laetitia en M1 semble surévaluée par le moteur (n=4 encore trop petit pour agir, mais net 2/2→0/2), (2) la confirmation peut écraser un signal "max des 4 forces" par ailleurs correct sur au moins 1 cas. **CORRIGÉ le 19/07/26** (demande utilisateur "rotation et fixe le même mode d'analyse... celui qui capte plus du vrai resultats") : exige maintenant fixe ET rotation d'accord (voir §6, section dédiée) — répare St. Louis (2/4→3/4 réel), coûte 18/27 sur l'archive (contre 22/27 avant), meilleur compromis mesuré face à un remplacement pur par la rotation (17/27). Laetitia/Albus reste un MISS (même la rotation ne confirme rien sur ce cas précis) | **Actif, repli quand 2c et 2d sont indécis, PRIORITAIRE sur "max des 4 forces"** (demande explicite utilisateur, 18/07/26, condition ET fixe/rotation ajoutée le 19/07/26) — se déclenche sur une base désormais plus stricte (fixe ET rotation), fréquence sur thèmes aléatoires non revérifiée depuis ce changement |
...
| Match FIFA (19/07/26) M1=Conjunctio/M7=Puella | conjunctio/laetitia/via/cauda_draconis | 6-5, **M1** | — | **HIT (Équipe 1) via Max des 4 forces** (M1=1060, M7=790, R1=**1080** max absolu, R7=1060), fixe et rotation d'accord. Réel **6-5 M1**. **⚠️ CORRECTIF MÉTHODOLOGIQUE (19/07/26, demande utilisateur "les matchs de FIFA les buts sont gonflés prends en compte, un match fermé peut se retrouver avec 6 buts")** : le score "3-1" initialement noté ici venait d'un script de test qui n'avait PAS explicitement fixé la compétition (`competitionOverride` non passé → repli sur le défaut codé en dur `fra_l1`/tier 1/`multButs=1`, PAS l'esport tier 7/`multButs=2.5` pourtant déjà prévu et exclu de la réduction "fermé" dans le code — voir `buildScoreFromCamps`). **Recalculé avec `competition='esport_fc26_rush'`** (score FIFA/esport typique) et le vainqueur correctement aligné sur `verdictFinal` (pas le duel brut de la carte, qui divergeait) : **score corrigé 5-3**, beaucoup plus proche du réel 6-5 (erreur absolue 3 au lieu de 7). `matchFermeOuvert` reste FERMÉ mais ce n'est plus un MISS "à l'opposé" une fois l'inflation esport prise en compte correctement — **retiré du track record matchFermeOuvert** (celui-ci ne s'applique de toute façon jamais en esport, `esportComp` l'exclut déjà dans le code ; le "MISS" précédent était un artefact du script, pas du moteur). **8e vrai match hors archive pour le palier Max des 4 forces : 7/8** (vainqueur seul, inchangé). **Test en temps réel du signal Air (voir §6, "sens pratique pour le verdict")** : M1=Conjunctio est une figure Air — le camp Air GAGNE ici, 2e démenti réel après West Ham-Liverpool — reste non intégrable |
| Match FIFA (19/07/26) M1=Tristitia/M7=Populus — **TIRAGE MAL PRIS, EXCLU** | tristitia/carcer/populus/rubeus | 6-3, **M1** | — | **NON COMPTABILISÉ (demande utilisateur "ignore ce match il a été mal pris", 19/07/26)** — tirage invalide, même traitement que Ventura County vs Los Angeles II (§3) : conservé ici pour mémoire mais retiré de tous les track records. `verdictFinal` avait prédit Équipe 2 via Max des 4 forces (R7=1015 max), réel Équipe 1 6-3 — **ne compte PAS** dans le palier Max des 4 forces (reste **7/8**, pas 7/9). `matchFermeOuvert` avait signalé FERMÉ (9/16) contre un score réel qui a explosé — **ne compte pas non plus** dans son track record (reste **6/10**, pas 6/12 — voir aussi le correctif méthodologique esport sur le match Conjunctio juste au-dessus, qui retire aussi ce match-là du décompte) |
| Match FIFA (19/07/26) M1=Caput Draconis/M7=Cauda Draconis | caput_draconis/puella/conjunctio/carcer | 2-0, **M1** | — | **HIT (Équipe 1) via ⚔️ Guerre civile** (M7 trahi par son binôme : Acquisitio en M5 frappe Laetitia et protège ainsi Via, l'arme adverse). Score prédit (esport, vainqueur aligné) **5-2** — réel **2-0** : **vainqueur correct, écart net proche** (+3 prédit contre +2 réel) mais **magnitude largement sous-estimée dans le sens inverse cette fois** (7 buts prédits contre seulement 2 réels — le match s'est refermé au lieu d'exploser). **Interprétation utilisateur (19/07/26, "c'est vraiment cette fragilité qui a diminué le score")** : M1=Caput Draconis est une figure Air (signal de fragilité, §6) — la doctrine utilisateur attribue la baisse du score à cette fragilité, PAS comme "le camp Air perd" (il gagne toujours, 3e cas réel consécutif où Air ne perd pas : West Ham-Liverpool, Conjunctio/Laetitia, celui-ci) mais comme **"le camp Air marque moins que prévu même en gagnant"** — nouvelle hypothèse distincte à suivre (n=1 pour cette forme précise), voir §6 pour la mise à jour du suivi Air |
| Match FIFA (19/07/26) M1=Laetitia/M7=Albus | laetitia/rubeus/cauda_draconis/laetitia | 7-3, **M7** | — | **MISS NET — `verdictFinal` prédit Équipe 1 via Confirmation résultante+binôme** (Laetitia confirmée par sa résultante et son binôme en harmonie, M7 non). Score prédit (esport, vainqueur aligné) **5-2 Équipe 1** — réel **7-3 Équipe 2** : vainqueur ET sens du score totalement inversés. **4e vrai match hors archive pour ce palier : track record réel passe à 1/4** (après 1 HIT, 3 MISS — Laetitia/Tristitia, St. Louis, celui-ci), très en dessous du 9/10 observé sur l'archive complète. `matchFermeOuvert` disait OUVERT (5/16, cohérent avec un score élevé, ça au moins tient). Ni M1 (Laetitia) ni M7 (Albus) n'est une figure Air. **Ce palier reste le mécanisme le mieux validé sur l'archive (9/10 isolé, +3 net sur verdictFinal) mais son track record réel (1/4) mérite maintenant une vraie vigilance** — à surveiller de très près sur les prochains vrais matchs avant d'envisager quoi que ce soit (aucun changement de code pour l'instant, l'archive reste la base de validation la plus large et la plus stable) |
...
**PREMIER VRAI TEST EN CONDITIONS RÉELLES (19/07/26)** : match FIFA
M1=Conjunctio (figure Air) vs M7=Puella, prédiction `verdictFinal`
Équipe 1 via Max des 4 forces (voir §3) — réel **6-5 Équipe 1, le camp
Air GAGNE**. **2e démenti réel du signal Air** (après West Ham vs
Liverpool où M7=Caput Draconis avait aussi gagné) — track record réel
du signal Air isolé (hors archive) passe à **0/2**, à l'opposé du 7/8
observé sur l'archive. Confirme qu'il était juste de ne PAS l'avoir
intégré au verdict malgré son score isolé impressionnant sur
l'archive — un signal statistiquement fort peut rester peu fiable en
usage réel ponctuel (n encore beaucoup trop petit des deux côtés pour
trancher lequel, archive ou réel, est le plus représentatif).

**HYPOTHÈSE AIR REFORMULÉE (19/07/26, 3e cas réel, M1=Caput Draconis
vs M7=Cauda Draconis, réel 2-0 M1)** : 3e victoire réelle consécutive
d'un camp Air (après Conjunctio et Caput Draconis-M7 sur West Ham) —
la forme stricte "le camp Air perd" reste donc à **0/3 en réel**,
nettement contredite. Mais l'utilisateur propose une reformulation
("c'est vraiment cette fragilité qui a diminué le score") : plutôt que
perdre, le camp Air **marquerait moins que prévu**, y compris en
gagnant. Cohérent sur ce cas précis (prédit 5 buts pour Équipe 1/Air,
réel seulement 2) mais **n=1 pour cette forme exacte** — à re-mesurer
sur Conjunctio (prédit 5, réel 6 pour le camp Air : NE colle PAS avec
cette version — le camp Air a au contraire marqué PLUS que prévu sur
ce cas-là) et sur West Ham (Caput Draconis camp M7, réel 6 buts contre
un prédit non recalculé avec la bonne compétition à l'époque). Les 3
cas réels ne pointent donc pas encore dans une direction unique
propre — la fragilité Air se lit clairement sur la cartographie
structurelle (§6, houses/figures) et se reflète dans le taux de
victoire sur l'archive (7/8), mais sa traduction exacte en magnitude
...
aucun cas dans cette configuration précise.

**RETESTÉ EN CASCADE COMPLÈTE SUR LES 4 VRAIS MATCHS (19/07/26,
demande utilisateur "ils doivent utiliser le même principe d'analyse
celui qui capte plus du vrai resultats")** — pas seulement le palier
isolé mais `verdictFinal` en entier (la trahison directe, placée avant,
corrige déjà Laetitia/Tristitia indépendamment de ce palier) :

| Variante | Vrais matchs (n=4) | Archive (n=27) |
|---|---|---|
| Fixe (avant ce correctif) | 2/4 | 22/27 |
| Rotation seule | 3/4 | 17/27 |
| **ET (fixe ET rotation confirment)** | **3/4** | **18/27** |
| OU | 2/4 | 22/27 |

Rotation seule et ET donnent le même gain réel (répare St. Louis
City SC vs Sporting Kansas City, 2/4→3/4 ; ne répare pas Laetitia/
Albus, où même la rotation ne confirme rien et où "max des 4 forces"
se trompe aussi en repli) — ET coûte un peu moins cher sur l'archive
(18/27 contre 17/27). **INTÉGRÉ (19/07/26)** : `confirmationResultanteBinome`
exige maintenant l'accord des positions fixes ET des positions de
rotation (`getRotationOrderFromRepos`) pour confirmer un camp — voir
`verdictFinal`. Vérifié : 18/27 sur l'archive, 3/4 en réel, 0 crash.
Nouveau statut de ce palier : **9/10 isolé → à revalider avec la
condition ET** (pas encore recalculé isolément, seulement en cascade
complète) ; track record réel isolé passe de 1/4 à 2/4 sur la
correction directe de ce palier (Laetitia/Tristitia et Laetitia/Albus
